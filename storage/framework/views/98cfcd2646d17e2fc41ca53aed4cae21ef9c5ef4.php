...
<div class="container">
    <div class="mb-3">
        <a class="btn <?php echo e(in_array($request_path, ['my/index', 'my/edit']) ? 'btn-primary' : 'btn-outline-primary'); ?>" href="/my/index" role="button">基本信息</a>
        <a class="btn <?php echo e($request_path === 'my/order' ? 'btn-primary' : 'btn-outline-primary'); ?> ml-2" href="/my/order" role="button">我的订单</a>
        <a class="btn <?php echo e($request_path === 'my/collect' ? 'btn-primary' : 'btn-outline-primary'); ?> ml-2" href="/my/collect" role="button">我的收藏</a>
        <a class="btn <?php echo e($request_path === 'my/like' ? 'btn-primary' : 'btn-outline-primary'); ?> ml-2" href="/my/like" role="button">我的点赞</a>
    </div>
    <div>
        <form id="edit-form">
            <div class="form-group">
                <label for="exampleInputEmail1">用户名</label>
                <input type="text" class="form-control" id="exampleInputEmail1" readonly value="<?php echo e($user['name']); ?>" data-toggle="tooltip" data-placement="top" title="用户名禁止修改">
            </div>
            <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('shop1.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\laravel_project\resources\views/shop1/my/edit.blade.php ENDPATH**/ ?>