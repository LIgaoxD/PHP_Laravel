...
<body>
    ...
    <nav class="site-header sticky-top py-1">
        <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center" style="color: black;">
            ...
            <a class="py-2" href="/" aria-label="Product" title="<?php echo e($site_name); ?>">
                ...
                <span class="ml-1" style="color: black;"><?php echo e($site_name); ?></span>
            </a>
            <div>
    ...
    <footer class="container py-4">
        <div class="row">
            <!-- 版权信息 -->
            <small class="mb-3 mx-auto text-muted" ><?php echo e($site_name); ?><i class="fa fa-globe" aria-hidden="true"style="margin: 12px;"></i>
...
</html><?php /**PATH D:\www\laravel_project\resources\views/shop1/layout/base.blade.php ENDPATH**/ ?>